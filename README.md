...
footer. The current release is `v0.46.2`; local and published images use the
...
- Pushing a tag such as `v0.46.2` publishes `0.46.2`, `0.46`, and `latest`.
...
```console
ARTIST_TRACKARR_IMAGE=ghcr.io/crypt0rr/artist-trackarr:0.46.2 docker compose up -d
```
